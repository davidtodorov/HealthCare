    ...
    public partial class PushNotifications : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "PrescriptionNotificationLogs",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PrescriptionNotificationLogs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PrescriptionNotificationLogs_Prescriptions_PrescriptionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PrescriptionNotificationLogs_PrescriptionId_ScheduledFor",
                table: "PrescriptionNotificationLogs",
                columns: new[] { "PrescriptionId", "ScheduledFor" },
                unique: true);
