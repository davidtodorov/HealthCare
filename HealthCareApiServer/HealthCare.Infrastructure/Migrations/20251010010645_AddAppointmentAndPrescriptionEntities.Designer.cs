...
namespace HealthCare.Infrastructure.Migrations
{
    ...
    [Migration("20251010010645_AddAppointmentAndPrescriptionEntities")]
    partial class AddAppointmentAndPrescriptionEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HealthCare.Core.Entities.Appointment", b =>
                {
                    b.HasOne("HealthCare.Core.Entities.User", "Doctor")
                        .WithMany()
                        .HasForeignKey("DoctorId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("HealthCare.Core.Entities.User", "Patient")
                        .WithMany()
