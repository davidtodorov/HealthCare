...
public abstract class HealthCareWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static HealthCareWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(HealthCareWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<HealthCareDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<HealthCareDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<HealthCareDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<HealthCareDbContext, Task<T>> func)
    {
        T result;
